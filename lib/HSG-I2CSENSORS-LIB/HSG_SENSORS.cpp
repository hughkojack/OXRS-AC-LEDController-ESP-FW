...
bool HSG_SENSORS::scanI2CAddress(byte address, const char * name)
{
...
void HSG_SENSORS::setConfigSchema(JsonVariant json)
{
...
void HSG_SENSORS::setCommandSchema(JsonVariant json)
{
  // no commands
}

void HSG_SENSORS::conf(JsonVariant json)
{
...
void HSG_SENSORS::cmnd(JsonVariant json)
{
  // no commands to handle
}

void HSG_SENSORS::tele(JsonVariant json)
{
